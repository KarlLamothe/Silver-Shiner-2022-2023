...
# read in power data
Power.df <- read.xlsx("Results/Power-Analysis/Power-simulations-results.xlsx", sheetName = "Sheet1", header=T)
...
# plot
tiff("Results/Power-Analysis/Total.power.tiff", units='in', height=6, width=7.5, res=800)
...
tiff("Results/Power-Analysis/Alpha05.power.tiff", units='in', height=3, width=7.5, res=800)
...
tiff("Results/Power-Analysis/Alpha20.power.tiff", units='in', height=3, width=7.5, res=800)
